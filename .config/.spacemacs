...
values."
  (setq-default
   ...
   '(python
     ...
     org-journal-dir "~/.local/org-files/journal/")
     ;; (shell :variables
   ...
   dotspacemacs-additional-packages '(impatient-mode
                                      org-journal
                                      org-roam
                                      calendar
                                      elixir-mode
